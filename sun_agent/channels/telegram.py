...
from sun_agent.config.paths import get_media_dir
from sun_agent.config.schema import Base
from sun_agent.security.network import validate_url_target
from sun_agent.utils.helpers import split_message
...
class TelegramChannel(BaseChannel):
    ...
    async def _on_start(self, update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
        ...
        await update.message.reply_text(
            f"👋 Hi {user.first_name}! I'm sun_agent.\n\n"
