...
from sun_agent.agent.memory import MemoryConsolidator
from sun_agent.agent.subagent import SubagentManager
from sun_agent.agent.tools.cron import CronTool
from sun_agent.agent.skills import BUILTIN_SKILLS_DIR
from sun_agent.agent.tools.filesystem import EditFileTool, ListDirTool, ReadFileTool, WriteFileTool
...
class AgentLoop:
    ...
    def _ensure_current_provider(self) -> None:
        ...
        from sun_agent.cli.commands import _make_provider
    ...
    async def _connect_mcp(self) -> None:
        ...
        from sun_agent.agent.tools.mcp import connect_mcp_servers
        try:
    ...
    async def _handle_restart(self, msg: InboundMessage) -> None:
        ...
        async def _do_restart():
            ...
            # Use -m sun_agent instead of sys.argv[0] for Windows compatibility
            # (sys.argv[0] may be just "sun_agent" without full path on Windows)
            os.execv(sys.executable, [sys.executable, "-m", "sun_agent"] + sys.argv[1:])
